...
Teams from outside New Zealand may usually enter the [SPAR](https://sppcontests.org/spar/) contest (formerly the ANZAC League) which runs at the same time and uses the same problem set.


## Categories

There are [5 categories](/categories/) under which teams may compete, each category having its own winner.  The categories range from school pupils to professional programmers.


## Sites

Teams must compete at one of the [official sites](/sites/), although we will be flexible if any part of New Zealand is in lockdown.
 
Teams formally register at the start of the contest, but once registration is open (2-3 weeks before the contest), team managers may reserve places for their teams using the [Registration Page](/register/).
